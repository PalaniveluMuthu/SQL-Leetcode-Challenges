...
--### Two Solutions in SQL Server and MySQL
...
(
    SELECT p.product_name , o.product_id,o.order_id,o.order_date,
          DENSE_RANK() OVER(PARTITION BY o.product_id ORDER BY o.order_date DESC) Lastest_Order_Rank
    FROM 
    Orders o
    INNER JOIN
    Products p
...
--### Option 2: MySQL
    ...
    (
     SELECT product_id , MAX(order_date) Order_date FROM orders GROUP BY product_id
    )
    ORDER BY 1,2,3;